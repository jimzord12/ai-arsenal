...
> **Status:** Workflow v2 is delivered; the Trello Flow CLI `0.4.0` release candidate and reproducible skills-install byte proof are independently verified, with exact-SHA CI and global installation pending
> **Living-plan schema:** 1.0
> **Last reconciled:** 2026-07-29
> **Current phase:** Commit and push the reviewed `0.4.0` release candidate, then require exact-SHA Quality and Portability CI before installation
