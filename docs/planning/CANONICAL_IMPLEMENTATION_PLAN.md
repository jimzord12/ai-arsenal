...
> **Status:** Workflow v2 review-barrier integration, fail-closed CLI delivery evidence, isolated-worktree-per-item development, legacy Features CLI junction retirement, repaired weekly-report CLI `0.1.1`, and Trello Flow CLI `0.7.0` per-command help are delivered
> **Living-plan schema:** 1.0
> **Last reconciled:** 2026-08-04
> **Current phase:** Trello Flow CLI authoring and discovery UX continues with issue #23
...
- `[VERIFIED]` The private `@jz/ai-arsenal-trello-work-cli` package is globally installed as `0.7.0`, exposing only `jz-trello-flow`. Artifact commit `6f59cb1f5246e5eec1d5fe3e4fbf96d5c620b13d` passed [Quality](https://github.com/jimzord12/ai-arsenal/actions/runs/30916419572) and [Windows/Linux Portability](https://github.com/jimzord12/ai-arsenal/actions/runs/30916418727). Its exact 32-file tarball SHA-256 is `bb8d22da2e8202c034823597aa4c5577dfe36b61cd2021074ca540a0daf10891`; the installed `src/cli.ts` byte hash `15718b7bed0ab51fbf9f942efb180614791ba5363661c7b5102de90054f39713` matches the unpacked artifact, and the repaired generated shims pass Git Bash `--version`, `--help`, `docs --list`, and `draft create --help` plus CMD and PowerShell version smoke. The exact `0.6.0` tarball (SHA-256 `c842e57ad900c717b572d6f117b99c8bb49f7b1faa00841995ff8b96232329b4`) is the ready rollback artifact; registry publication remains unapproved.
