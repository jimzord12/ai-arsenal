...
- Implementation is limited to one normative protocol document. It must not create skills, change CLI behavior, mutate Trello, publish or install packages, repair Git Bash compatibility, archive cards, delete rollback sources, or mutate Git history.
...
- Paths: `docs/workflow/TRELLO_AGENT_DEVELOPMENT_PROTOCOL.md`
...
- Test command: `pnpm exec prettier --check docs/workflow/TRELLO_AGENT_DEVELOPMENT_PROTOCOL.md`
...
- Test command: `git diff --check -- docs/workflow/TRELLO_AGENT_DEVELOPMENT_PROTOCOL.md`
...
- Test command: `pnpm exec prettier --check docs/workflow/TRELLO_AGENT_DEVELOPMENT_PROTOCOL.md && node scripts/validate-living-workflow.mjs && node scripts/validate-monorepo-work-item.mjs --work-item 2026-07-29-trello-agent-workflow-protocol --json && git diff --check`
...
- `docs/workflow/TRELLO_AGENT_DEVELOPMENT_PROTOCOL.md`
...
1. `pnpm exec prettier --check docs/workflow/TRELLO_AGENT_DEVELOPMENT_PROTOCOL.md`
