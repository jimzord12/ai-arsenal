...
The normative contract is [`packages/trello-work-cli/assets/agent-workflow-protocol.md`](../../../packages/trello-work-cli/assets/agent-workflow-protocol.md). Use the installed `jz-trello-flow` version and its offline docs as command authority.
